...
$route['transaction/edit'] = 'TransactionController/editTransaction';
$route['transaction/delete'] = 'TransactionController/deleteTransaction';
$route['transaction/update'] = 'TransactionController/updateTransaction';
