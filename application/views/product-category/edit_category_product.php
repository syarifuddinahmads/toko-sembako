...
<div class="container mt-4 mb-4">
	<form action="<?php echo site_url('product/category/update')?>" method="post" enctype="multipart/form-data">
		...
		<div class="card">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="name" value="<?php echo $category_product->name?>" required>
						</div>
					</div>
				</div>
			</div>
			<div class="card-footer">
				<div class="text-right">
					...
					<button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Update Product Category</button>
				</div>
			</div>
		</div>
	</form>
